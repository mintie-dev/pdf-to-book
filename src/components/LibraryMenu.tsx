...
const LibraryMenu = ({ open, onClose }: LibraryMenuProps) => {
  ...
  return (
    <>
      ...
      <div className="fixed right-0 top-0 bottom-0 z-50 w-80 max-w-[85vw] bg-card border-l border-border shadow-2xl animate-[slide-in-right_0.3s_ease-out] overflow-y-auto">
